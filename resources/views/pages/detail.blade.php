              ...
              <div class="col-12 col-lg-8">
                <ul class="list-unstyled">
                  ...
                  <li class="media">
                    ...
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Lukam Risky</h5>
                  ...
                  <li class="media">
                    ...
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Baba Risky</h5>
                      Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates tempore similique optio veritatis doloribus eos!
                    </div>
                  </li>
                </ul>
              </div>
